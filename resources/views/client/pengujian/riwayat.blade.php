...
@section('title', 'Riwayat Pengukuran DASS-21 Saya')
...
<div class="consultation-container">
    ...
    <div class="header-section">
        <div class="header-content">
            <h1 class="header-title">Riwayat Pengukuran DASS-21</h1>
            <p class="header-subtitle">Pantau hasil pengukuran mental Anda dari waktu ke waktu</p>
            <a href="{{ route('disclaimer') }}" class="new-consultation-btn rounded-full">
                <span style="font-size: 20px;">🧠</span>
                Mulai Pengukuran DASS-21
            </a>
        </div>
    </div>
    ...
    <div class="timeline-section">
        <div class="timeline-header">
            ...
            <span>Riwayat Hasil Pengukuran</span>
        </div>

        @if($pengujian->isEmpty())
        <div class="empty-state">
            <div class="empty-icon">📄</div>
            <h3 class="empty-title">Belum ada hasil pengukuran</h3>
            <p class="empty-description">Lakukan pengukuran pertama Anda untuk melihat hasil di sini</p>
            ...
            <div class="consultation-card">
                <div class="card-header">
                    <div class="layanan-info">
                        <h3 class="layanan-name">Hasil Pengukuran ke-{{ $index + 1 }}</h3>
                ...
                <div class="actions-section">
                    ...
                    <form action="{{ route('client.pengujian.hapus', $uji->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data riwayat pengukuran ini?')" style="display:inline-block;">
                        @csrf
                        @method('DELETE')
