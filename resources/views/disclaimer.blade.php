    ...
    <div class="row align-items-center" style="min-height: 80vh;">
        ...
        <div class="col-md-6 d-flex justify-content-center">
            <div class="d-flex align-items-center">
                <img src="{{ asset('images/disclaimer/Disclaimer.png') }}" alt="Ilustrasi Pengukuran DASS-21"
        ...
        <div class="col-md-6">
            ...
            <p><strong>Kenali kondisi mentalmu lewat pengukuran singkat DASS-21</strong><br>
            ...
            <div class="mb-3">
                ...
                <ol>
                    ...
                    <li>Pengukuran ini tidak dibatasi waktu.</li>
                    <li>Apabila keluar saat pengisian, proses akan terhenti dan mohon mengisi ulang.</li>
                    <li>Hasil pengukuran bisa didapatkan setelah mengisi semua pertanyaan.</li>
                </ol>
            </div>

            <div class="mb-4">
                <a href="{{ route('pengujiandass21') }}" class="btn btn-lg text-white btn-cta">Mulai Pengukuran Sekarang</a>
            </div>
        </div>
